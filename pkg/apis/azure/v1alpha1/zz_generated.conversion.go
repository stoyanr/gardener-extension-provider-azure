...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*AzureResourceReference)(nil), (*azure.AzureResourceReference)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_AzureResourceReference_To_azure_AzureResourceReference(a.(*AzureResourceReference), b.(*azure.AzureResourceReference), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*azure.AzureResourceReference)(nil), (*AzureResourceReference)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_azure_AzureResourceReference_To_v1alpha1_AzureResourceReference(a.(*azure.AzureResourceReference), b.(*AzureResourceReference), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_AzureResourceReference_To_azure_AzureResourceReference(in *AzureResourceReference, out *azure.AzureResourceReference, s conversion.Scope) error {
	out.Name = in.Name
	out.ResourceGroup = in.ResourceGroup
	return nil
}

// Convert_v1alpha1_AzureResourceReference_To_azure_AzureResourceReference is an autogenerated conversion function.
func Convert_v1alpha1_AzureResourceReference_To_azure_AzureResourceReference(in *AzureResourceReference, out *azure.AzureResourceReference, s conversion.Scope) error {
	return autoConvert_v1alpha1_AzureResourceReference_To_azure_AzureResourceReference(in, out, s)
}

func autoConvert_azure_AzureResourceReference_To_v1alpha1_AzureResourceReference(in *azure.AzureResourceReference, out *AzureResourceReference, s conversion.Scope) error {
	out.Name = in.Name
	out.ResourceGroup = in.ResourceGroup
	return nil
}

// Convert_azure_AzureResourceReference_To_v1alpha1_AzureResourceReference is an autogenerated conversion function.
func Convert_azure_AzureResourceReference_To_v1alpha1_AzureResourceReference(in *azure.AzureResourceReference, out *AzureResourceReference, s conversion.Scope) error {
	return autoConvert_azure_AzureResourceReference_To_v1alpha1_AzureResourceReference(in, out, s)
}
...
func autoConvert_v1alpha1_NatGatewayConfig_To_azure_NatGatewayConfig(in *NatGatewayConfig, out *azure.NatGatewayConfig, s conversion.Scope) error {
	...
	out.IPAddresses = *(*[]azure.AzureResourceReference)(unsafe.Pointer(&in.IPAddresses))
	out.IPAddressRanges = *(*[]azure.AzureResourceReference)(unsafe.Pointer(&in.IPAddressRanges))
	return nil
}
...
func autoConvert_azure_NatGatewayConfig_To_v1alpha1_NatGatewayConfig(in *azure.NatGatewayConfig, out *NatGatewayConfig, s conversion.Scope) error {
	out.Enabled = in.Enabled
	out.IPAddresses = *(*[]AzureResourceReference)(unsafe.Pointer(&in.IPAddresses))
	out.IPAddressRanges = *(*[]AzureResourceReference)(unsafe.Pointer(&in.IPAddressRanges))
	return nil
}
